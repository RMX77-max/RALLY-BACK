...
class ArchivoRallyController extends Controller
{
    ...
    {
        $data = $request->validate(['archivo' => 'required|file|mimes:jpg,jpeg,png,webp,pdf,gpx,kml|max:15360', 'carpeta' => 'nullable|in:banners,mapas,equipos,galeria,etapas,videos,documentos']);
